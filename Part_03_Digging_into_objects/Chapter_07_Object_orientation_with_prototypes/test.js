...
// Creates an object instance of Teacher
let teacher = new Teacher('Hillary', 'Duff', 23, 'f', ['reading', 'cycling'], 'Maths');
console.log(teacher.bio());
// Her name is Hillary Duff. She likes reading and cycling. And she teaches Maths.
